...
//@interface Borg_Daniel_Project1Object : NSObject
//@end

@interface Borg_Daniel_Project1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Borg_Daniel_Project1Object class]])
		{
			for (NSString *key in [[(Borg_Daniel_Project1Object*)o modules] allKeys])
			{
