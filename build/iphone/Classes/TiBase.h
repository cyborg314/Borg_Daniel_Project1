...
// in simulator we redefine to format for Borg_Daniel_Project1 Developer console
...
{\
	NSString * exceptionName = [@"org.borg_daniel_project1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.borg_daniel_project1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIBorg_Daniel_Project1NativeItemNone = -1, 
	UIBorg_Daniel_Project1NativeItemSpinner = -2,
	UIBorg_Daniel_Project1NativeItemProgressBar = -3,
	
	UIBorg_Daniel_Project1NativeItemSlider = -4,
	UIBorg_Daniel_Project1NativeItemSwitch = -5,
	UIBorg_Daniel_Project1NativeItemMultiButton = -6,
	UIBorg_Daniel_Project1NativeItemSegmented = -7,
	
	UIBorg_Daniel_Project1NativeItemTextView = -8,
	UIBorg_Daniel_Project1NativeItemTextField = -9,
	UIBorg_Daniel_Project1NativeItemSearchBar = -10,
	
	UIBorg_Daniel_Project1NativeItemPicker = -11,
	UIBorg_Daniel_Project1NativeItemDatePicker = -12,
	
	UIBorg_Daniel_Project1NativeItemInfoLight = -13,
	UIBorg_Daniel_Project1NativeItemInfoDark = -14,
	
	UIBorg_Daniel_Project1NativeItemDisclosure = -15,
	
	UIBorg_Daniel_Project1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Borg_Daniel_Project1 instances of
