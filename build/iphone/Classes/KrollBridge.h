...
@interface Borg_Daniel_Project1Object : KrollCoverageObject {
#else
@interface Borg_Daniel_Project1Object : KrollObject {
#endif
@private
...
extern NSString * Borg_Daniel_Project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Borg_Daniel_Project1Object *_borg_daniel_project1;
    KrollObject* console;
	BOOL shutdown;
